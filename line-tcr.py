...
Bots=[mid,Amid]
admin=["u2c1b0efa99dcaefceced1d047f4a63f0","u09d040c087fb06dfbdd1c0d24c55b774"]
wait = {
    'contact':True,
    'autoJoin':True,
...
#Sc biar bot otomatis kirim pesan pembuka nama group dengan owner + yang leave juga
        ...
        if op.type == 15:
            if op.param2 in Bots:
                return
            Name = cl.getContact(op.param2).displayName
            ki.sendText(op.param1, "Good Bye " + Name)
...
#--------------ListGroup------------------#
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
            ...
            elif msg.text in ["Wkwk","wkwk","Wkwkwk","wkwkwk","Wk","wk"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
            ...
            elif msg.text in ["Hehehe","Hahaha","Hehe","Haha"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "10",
                ...
                if wait["clock"] == True:
            ...
            elif msg.text in ["$set","Setlastpoint","setlastpoint"]:
                    ...
                    wait2['ROM'][msg.to] = {}
                    print wait2
            elif msg.text in ["$read","Viewlastseen","viewlastseen"]:
